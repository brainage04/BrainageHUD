...
export DISPLAY=:182
export ALSOFT_CONF="/home/thomas/01_TM/Coding/Websites/brainage04.github.io/.local-icon-variants/round3/captures-ui/runtime/alsoft.conf"
exec /nix/store/b7hzgfqk2jfcbncp0vpabf73j0riqgq4-openjdk-25.0.4.1+1/bin/java "@/home/thomas/01_TM/Coding/Websites/brainage04.github.io/.local-icon-variants/round3/captures-ui/client-ui.args" "$@"
