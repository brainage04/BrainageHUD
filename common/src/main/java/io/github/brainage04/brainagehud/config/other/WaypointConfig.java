...
public class WaypointConfig {
     ...
     */
    @ConfigEntry.Gui.Tooltip public boolean alwaysShowNames = false;
    @ConfigEntry.Gui.Tooltip @ConfigEntry.BoundedDiscrete(min = 50, max = 200)
