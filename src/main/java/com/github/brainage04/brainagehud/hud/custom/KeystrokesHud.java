...
import com.github.brainage04.brainagehud.config.hud.custom.keystrokes.ClicksPerSecondFormat;
...
public class KeystrokesHud implements CustomHudElement<KeystrokesHudConfig> {
    ...
    public void render(TextRenderer renderer, DrawContext drawContext) {
        ...
        // render backdrop
        int backdropOpacity = getElementConfig().coreSettings.overrideGlobalBackdropOpacity ? getElementConfig().coreSettings.backdropOpacity : getConfig().backdropOpacity;
